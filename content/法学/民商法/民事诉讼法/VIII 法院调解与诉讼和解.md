...
- `法院调解`，又称`诉讼调解`，是指在`人民法院审判人员主持`下，双方当事人就民事权益争议自愿、平等协商，互谅互让，**达成协议**并**解决纠纷**的诉讼活动和结案方式。
- 它兼具两重属性：
...
- 适用`特别程序`、`督促程序`、`公示催告程序`的案件。[^1]
- `婚姻`等身份关系**确认**案件。[^2]
- 其他根据案件性质不得调解的案件。

> [!caution]
> 不能把“身份关系案件”一概等同于“不得调解”。真正不得调解的是`身份关系确认案件`；像离婚案件并非当然不能调解。
...
- 例外：
  ...
  - `涉外`民事诉讼中，经调解双方达成协议且要求发给判决书的，可以依协议内容制作判决书。
...
- 需由[[VII 多数人诉讼#三、无独立请求权第三人|无独立请求权第三人]]承担责任的，应经其同意；该第三人在调解书送达前反悔的，也应及时裁判。
