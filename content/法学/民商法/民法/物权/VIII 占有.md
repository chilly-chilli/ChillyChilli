...
- **体素**：对物具有事实上的管领、控制。
- **心素**：具有占有意思，即将物置于`自己事实支配之下`的自然意思。

占有的客体原则上限于**有体物**，包括动产和不动产。占有可以发生在**物的一部分上**，如占有一宗土地中的特定区域。

占有的主体可以是自然人、法人或非法人组织；法人、组织可通过工作人员或其他占有辅助人控制物。取得占有不以具有民事行为能力或基础法律行为有效为必要，无行为能力人具备自然的占有意思，也可取得占有。

> [!note] 准占有
> 对地役权等财产权的实际行使不属于对有体物的占有，学理上称为“准占有”，仅在规范目的允许时准用占有规则。
...
- 在承认取得时效的比较法上，占有期间是权利取得的中心事实；我国现行法未建立一般取得时效制度。
...
- 占有保护中，无权占有人也可受保护。
- 善意占有、恶意占有的划分**以无权占有为前提。**

> [!caution] 无权占有也受占有保护
> 无权占有不等于占有不受保护。无权占有人不能对抗权利人的返还请求，但**可对抗第三人**的侵夺、妨害，以维护事实秩序。
...
| 类型   | 判断标准                 | 效果重点                  |
| ---- | -------------------- | --------------------- |
| 善意占有 | 无权占有人**误信**自己有占有权源   | 费用偿还、使用利益、毁损灭失责任上较受优待 |
...
间接占有的成立基础是**占有媒介关系**，如租赁、借用、保管、质押等。

直接占有人承认将来负返还义务，间接占有人通过该返还请求权维持观念上的管领。

间接占有的构成要点：

1. 存在直接占有人的他主占有。
2. 直接占有系依间接占有人的意思取得或维持。
3. 间接占有人对直接占有人享有返还请求权，且直接占有人承认其更高层级的占有地位。

占有媒介关系不以合同有效为必要。即使租赁、保管合同因行为能力等原因无效，只要直接占有人仍承认将来返还义务，间接占有仍可成立。
...
| 类型 | 判断标准 | 示例 | 主要意义 |
| --- | --- | --- | --- |
| 自主占有 | 以所有的意思占有 | 所有人、小偷、拾得后据为己有者、所有权保留买受人 | 先占、善意取得及比较法上的取得时效通常要求自主占有 |
| 他主占有 | 不以所有的意思占有，承认他人所有 | 承租人、借用人、保管人、质权人、留置权人 | 不发生以所有意思占有为前提的取得效果 |
...
| 分类 | 含义 | 主要意义 |
| --- | --- | --- |
| 和平占有 vs. 强暴占有 | 是否以暴力、胁迫方式取得或维持占有 | 主要服务于比较法上的取得时效分类 |
| 公然占有 vs. 隐秘占有 | 占有状态是否公开可被识别 | 主要服务于比较法上的取得时效分类 |
...
- **简单共同占有**：各占有人均可独立支配，同时顾及他人占有，如合租人共同使用客厅。
- **统一共同占有**：须数人协力才能支配物，如一人掌握车钥匙、另一人掌握车库钥匙。

> [!caution] 我国法下的分类意义
> 和平/强暴、公然/隐秘的分类主要服务于比较法上的取得时效。我国现行法未建立一般取得时效制度，该组分类的独立规范意义有限；侵夺或妨害是否违法，仍须在占有保护规则中具体判断。
...
1. 前占有人放弃其占有。
2. 前占有人具有使现占有人取得占有的意思。
3. 现占有人取得事实管领力。

基础买卖、赠与等法律行为无效，不当然否定占有已经移转。占有的取得也可通过占有辅助人完成。
...
- **创设间接占有**：原占有人将物交由承租人、保管人等直接占有，自己保留间接占有；或通过占有改定为受让人创设间接占有。
- **移转间接占有**：间接占有人让与对直接占有人的返还请求权，受让人取得间接占有。
- **继承取得**：继承开始时，继承人原则上当然承继遗产物的占有，不以实际接触遗产或知道继承事实为必要。
...
- 他人单纯声称对物享有权利并请求返还，通常不足以使占有人转为恶意。
- 权利人提起返还诉讼并最终胜诉的，教材认为可自起诉状送达时起认定占有人转为恶意。
...
- 直接占有人终局丧失占有，间接占有随之失去媒介。
- 间接占有人放弃占有或让与其返还请求权。
- 间接占有人的返还请求权因条件成就、债务清偿等原因消灭。
...
自力救济原则上由直接占有人实施；间接占有人因不直接控制物，通常只能请求公力救济。占有辅助人虽非占有人，但可为维护占有人的占有实施必要防御。

自力取回应当与侵夺过程紧密连续：

- 动产须在侵夺当场或立即、不间断追踪过程中取回。
- 不动产须在侵夺初期立即驱逐侵夺人。
- 侵夺人已经稳定建立新占有后，不得再以自力取回代替诉讼。
...
占有物返还请求权要求存在“**侵夺**”，即违背占有人意思而违法剥夺其事实管领：

- 因遗失而丧失占有，不属于侵夺。
- 直接占有人否认间接占有人的地位，虽可能构成违约或无权占有，也不当然属于侵夺。
- 侵夺人已不再占有标的物时，不能再向其请求返还原物，但可依条件主张损害赔偿。
- 善意取得占有的特定继受人原则上不承担占有返还义务；概括继受人和明知占有瑕疵的特定继受人仍可能成为相对人。
...
- 原则上适用于动产；已登记不动产以登记推定为中心，未登记不动产仍可能有适用余地。
- 现在自主占有人原则上推定为现在所有权人；前占有人可推定其在占有期间为所有权人。
- 存在直接、间接占有时，直接占有人为他主占有的，原则上推定最高层级的间接自主占有人为所有权人。
- 以质权等定限物权意思占有的，推定其享有相应权利，但不得以该推定对抗使其取得占有的人。
- 权利推定只是证明责任规则，有相反证据时即被推翻；占有通过盗窃取得并不阻止推定产生，但盗窃事实一经证明，即足以推翻推定。
...
- 善意取得：受让人须善意取得占有。
- 先占：以所有意思先于他人占有无主动产。
- 比较法上的取得时效：以持续自主占有为核心；我国现行法未设一般规则。
...
第459—461条原则上以所有权人或其他有占有权能的物权人依据第235条向**无权占有人**请求返还为前提。有权占有人与权利人之间的孳息、费用、损害等问题，通常应优先依据租赁、保管、质押等基础关系处理。
...
费用偿还还受获益抵扣限制：占有人已通过使用或收取孳息获得足以覆盖相关支出的利益时，不应就同一利益重复请求费用偿还。
...
> [!question] 恶意占有人的归责原则
> 第461条未明文以过错为恶意占有人赔偿不足损失的要件。依文义可解释为较严格的责任；依“优待善意占有人而非惩戒恶意占有人”的规范目的，也可主张仍应结合侵权法判断可归责性。教材认为该问题存在解释争议，作答时宜说明观点与理由。
