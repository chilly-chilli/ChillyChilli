...
- 动产所有权抛弃：需要抛弃意思 + 放弃占有。
- 动产定限物权抛弃：通常须向因抛弃而直接受益者作出意思表示，并返还占有。
- 不动产物权抛弃：除抛弃意思外，通常还需要办理注销登记或涂销登记；抛弃不动产定限物权时，还须向因抛弃直接受益者表示。
...
- 遗赠虽在《民法典》第 230 条中未被单列，教材认为受遗赠人依法接受遗赠后，其取得遗赠财产的效力可溯及继承开始时。
...
- 教材特别指出，动产占有通常只能发挥`消极公示`：不占有可能提示存在质权、租赁等他人权利，却不能积极、完整地说明物权类型与归属；交付作为变动要件还具有使权利取得与事实控制相协调的功能。
...
- 目前更常见的解释是`债权形式主义`：
  ...
  - 物权变动还需要处分权和公示要件。
  - 原因行为效力通常仍是物权变动的基础。
- 教材的具体立场更接近`承认物权行为独立性 + 坚持物权变动有因性`：
  - 债权行为与处分行为应当分离。
  - 现行法尚不足以明确支持物权行为无因性。
  - 当前司法实践通常认为原因行为无效、被撤销会影响物权变动。
...
> [!caution] 分离原则不等于无因原则
> 承认买卖合同与所有权移转行为相互独立，并不必然要求原因行为瑕疵对物权行为毫无影响。独立性回答“是否存在两个行为”，无因性回答“两个行为的效力是否牵连”。
...
>- 只有能够直接引起物权变动的形成性法律文书，才适用第 229 条；给付性、单纯确认性文书原则上不直接引起物权变动[^1]。
...
- 强制执行中的拍卖、变卖裁定或以物抵债裁定，如直接改变不动产权属，也属于第 229 条意义上的形成性法律文书。
...
- 原则上须办理不动产登记。
- 无处分权人的不动产处分原则上不发生物权效力；经权利人追认、处分人事后取得处分权，或者受让人符合善意取得要件时，物权变动可能得到补正或由法律特别规定发生。
- 所有权人已设定定限物权，不等于丧失处分权；其仍可转让所有权或再设其他权利，但后手取得的权利原则上承受在先物权负担。查封、预告登记等则可能直接限制处分效力。

### 3. 不动产登记的基本功能

| 功能 | 内容 |
| --- | --- |
| 确认功能 | 在首次登记中确认并纳入既有的不动产权利状态 |
...
- 权属证书由私人持有，并非公开查询的登记簿；仅信赖权属证书上的错误记载，通常不足以证明不动产善意取得中的善意。
...
- 依教材解释，登记机构可直接更正的典型情形：
  - 登记权利人发现错误并提出证据申请更正。
  - 登记权利人以外的利害关系人申请时，登记簿记载的权利人书面同意更正。
- 若利害关系人申请而登记权利人不同意，通常说明存在权属争议，登记机构不宜自行裁决；申请人可先办理异议登记并提起确权诉讼。
...
> [!caution] 抵押权预告登记的特殊性
> 预告登记的一般功能是限制未经同意的后续处分，但抵押权预告登记主要用于保全未来抵押权及其顺位。教材指出，不宜将其理解为绝对冻结所有后续处分；转为本登记后，抵押顺位原则上按预告登记时间确定。
...
- 构成要素：
  ...
  - 受让人取得占有。
  - 受让人取得占有由让与人的意愿促成。
- 受让人取得占有不限于亲自直接控制：交付给其占有辅助人，或者由受让人通过仓储人等取得间接占有，也可满足占有取得要求。
...
- 适用结构：
  ...
  - 当事人达成物权变动合意。
  - 无须再发生新的占有移转。
- 既存占有可为直接占有或间接占有，也不以既存占有本身有合法权源为必要。
...
- 是否须通知第三人：
  ...
  - 动产质权设立场景下，为确保质权人取得对质物的控制，应以返还请求权让与或质权设定通知到达直接占有人时认定质权设立。
...
- 若已办理所有权转移登记而让与人仍继续占有，教材倾向于结合双方明确的移转合意，将其解释为占有改定，而非认定“仅凭登记”即可脱离交付规则移转所有权。
...
[^1]: **形成性法律文书**能够直接设立、变更、转让或消灭物权，无须当事人另行实施登记申请以完成该物权变动。典型如共有物分割判决将共有房产判归一人、执行拍卖成交裁定或以物抵债裁定。给付判决仅命当事人协助办理登记，物权仍待登记发生变动；确认判决原则上只是确认既存权利状态，并非物权变动原因。
