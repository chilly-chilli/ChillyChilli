...
>[!cite] [[民法典#第一百一十八条-第2款|民法典第 118 条第二款]]的“债权”
>债权是因合同、侵权行为、无因管理、不当得利以及法律的其他规定，权利人请求特定义务人为或者不为一定行为的权利。

- ==债==：特定人间一方得请求他方为特定行为（**给付**）的法律关系
	- 所谓「`狭义债之关系`」
		- 通则 84、民法典 118-2 都是狭义
	- 广义的债：**特定人之间以给付义务为中心的法律关系**
		- *eg.买卖行为属于债之关系*
...
### （一）债权是财产权
>[[权利的分类#一、根据==权利内容== ：财产权/非财产权|根据权利的内容分类]]
- 给付具有财产价值或可给予经济评价
...
### （二）债权是请求权
>[[权利的分类#（二）请求权|根据权利的作用分类：请求权]]
- 债权的实现需依赖于债务人履行债务的行为
- 债权的效力主要就表现在可以请求债务人实施特定行为以满足债权
- 债权的非支配性
	- 债权非为对债务人（人身）的支配
	- 债权非为债务人行为的支配
	- 债权非为对债的关系所涉之标的物的支配
...
>[!question] 思考
>债权是请求权，这一表达在严格意义上是否正确？

>[!tip] 债权与请求权的关系
> - ”债权是财产权“意味着什么（处分等）
> - 债权的效力首先且主要的表现为请求权
> - 债权的效力不限于请求，还包括[[权利的分类#（三）抗辩权|抗辩]]、[[权利的分类#（四）形成权|形成]]、处分等
> - 请求权不限于债权请求权，还存在物权请求权
> >[!note] 结论： 
> >债权系「本权」（[[权利的分类#（一）原权与救济权|原生性权利]]），请求权系债权的效力，是债权效力的主要方法；不能将债权等同于请求权，而应注意债权的财产属性

### （三）债权是对人权，具有相对性
>[[权利的分类#（2）相对权|根据义务主体是否特定]]
...
> - 看似“反常识”的规则，理解债权合同的[[法律行为的分类#六、负担行为与处分行为|负担行为]]（而非处分行为）性质，至关重要
...
- 债务的内容包括积极的作为与消极的不作为
	...
	- 债务以不作为义务表现时，原则上此种债务仅因当事人间的特别约定而发生
		...
		- 将法定不作为义务约定为合同义务的，往往存在效力瑕疵（[[法律行为的生效与效力障碍#2. 违反公序良俗的法律行为：无效|违背公序良俗等]]）
...
> 	- 无论基础事实为何，其结果都是在观念世界中将两个特定主体用“宅债之关系”（“给付关系”）相结合
...
1. 什么是合同？
	1. 定义
		- 当事人设立、变更、终止民事权利义务的双方法律行为（“协议”）
			- 合同由两个意思表示构成，且此两个意思表示必须形成合致（意思表示一致）
			- 合同成立的判断：要约、承诺等
	2.  合同有广狭两义
		- 广义的合同（[[法律行为的分类#（1）**双方行为**|双方法律行为]]）
	...
	3. 合同之债
		- 合同之债属于典型的意定之债
			- 契约自由
		- 合同所产生的债属于[[Chap1. 债法总论#（一）债的概念|“广义”之债]]的关系
...
1. 定义
	- 【因（可归责于行为人的）原因】（因过错），导致他人权利或法益受损的，行为人对受害人应负损害赔偿之责，此种损害赔偿之债即为**侵权行为之债**
...
1. 定义
	- 因缔约接触，在缔约当事人间即应产生基于诚信原则的注意与保护义务
